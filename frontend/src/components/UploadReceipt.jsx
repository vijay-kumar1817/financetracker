...
//     <p>Extract expenses from a scanned POS receipt (Image or PDF)</p>
...
//     if (!file) return;
//     // TODO: Hook up backend OCR logic
//     alert(`Receipt upload not implemented yet: ${file.name}`);
//   };
...
//       <h3>Upload a Receipt</h3>
//       <p>Extract expenses from a scanned POS receipt (Image or PDF)</p>
//       <input type="file" accept=".jpg,.png,.pdf" onChange={handleFile} />
//     </div>
//   );
// };
...
// File: src/components/UploadReceipt.jsx
...
//           onUploadTransaction(transactions);
//           alert(`✅ ${transactions.length} transaction(s) added from receipt!`);
//         } else {
